    ...
    <main className="h-screen relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-30 p-3 sm:p-4">
        <div className="flex items-center gap-2 sm:gap-3">
          {/* Settings Icon */}
          <button 
            className="p-2.5 sm:p-3 bg-white rounded-full shadow-lg hover:bg-gray-50 transition-colors focus:ring-2 focus:ring-orange-500 focus:outline-none"
          ...
          <button 
            ...
            className="p-2.5 sm:p-3 bg-white rounded-full shadow-lg hover:bg-gray-50 transition-colors relative focus:ring-2 focus:ring-orange-500 focus:outline-none"
